...
def upgrade() -> None:
    # ### Nuevas tablas y columnas tipo ARRAY
    op.create_table(
        'widgets',
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), primary_key=True),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('steps_completed', ARRAY(String), nullable=True),   # <-- ARRAY tipo String
        sa.Column('tours_completed', ARRAY(String), nullable=True),  # <-- ARRAY tipo String
        sa.Column('last_step', sa.String(length=100), nullable=True),
        sa.Column('completed', sa.Boolean(), nullable=False, server_default='false'),
    )

    # Las tablas antiguas y alter column que ya tenías:
